...
# === Additional Info ===
# 
# - You may add additional classes and functions as needed provided they are all in the file `partC.py`.
# - Upload partC.py to Project 3 on T-Square in the Assignments section. Do not put it into an 
#   archive with other files.
# - Ask questions on Piazza if the directions or specifications are unclear.
#
